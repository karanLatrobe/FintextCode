...
urlpatterns = [
    ...
    # ⭐⭐ ADD THESE TWO IMPORTANT URLS ⭐⭐
    path("save-updated-db/", views.save_updated_db, name="save_updated_db"),
    path("download_excel_db/", views.download_excel_from_db, name="download_excel_from_db"),
